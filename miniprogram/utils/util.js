...
function formatLunar(lunarDate) {
...
const innerDate = (task,_date) => {
  ...
  task._lunar = formatLunar(getLunarDate(_date));
  task._month_zh = (_date.getMonth() + 1) + '月' + _date.getDate() + '日';
  task._week_zh = formatWeek_zh(_date.getDay());
}
